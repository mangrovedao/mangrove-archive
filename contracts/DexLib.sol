...
library DexLib {
  function setConfigKey(
    ...
    if (key == ConfigKey.takerFee) {
      ...
      emit DexEvents.SetMinFinishGas(value);
      ...
      emit DexEvents.SetminGasWanted(value);
      ...
      emit DexEvents.SetTransferGas(value);
    } else {
  ...
  function newOrder(
    ...
    emit DexEvents.NewOrder(msg.sender, wants, gives, gasWanted, orderId);
    return orderId;
  }

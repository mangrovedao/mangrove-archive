 ...
 */
abstract contract OnePageMangrove {
  /* # State variables */
  //+clear+
...
contract OnePageMMgv is OnePageMangrove {
  constructor(uint gasprice, uint gasmax)
    OnePageMangrove(gasprice, gasmax, "FMD")
  {}
...
contract OnePageTMgv is OnePageMangrove {
  constructor(uint gasprice, uint gasmax)
    OnePageMangrove(gasprice, gasmax, "FTD")
  {}

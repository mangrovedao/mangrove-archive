...
var MgvReader__factory = /** @class */ (function (_super) {
  __extends(MgvReader__factory, _super);
  function MgvReader__factory(signer) {
    return _super.call(this, _abi, _bytecode, signer) || this;
  }
  MgvReader__factory.prototype.deploy = function (_mgv, overrides) {
    return _super.prototype.deploy.call(this, _mgv, overrides || {});
  };
  MgvReader__factory.prototype.getDeployTransaction = function (
    _mgv,
    overrides
  ) {
  ...
  MgvReader__factory.prototype.attach = function (address) {
    return _super.prototype.attach.call(this, address);
  };
  MgvReader__factory.prototype.connect = function (signer) {
    return _super.prototype.connect.call(this, signer);
  };
  MgvReader__factory.createInterface = function () {
    return new ethers_1.utils.Interface(_abi);
  };
  MgvReader__factory.connect = function (address, signerOrProvider) {
    return new ethers_1.Contract(address, _abi, signerOrProvider);
  };
  MgvReader__factory.bytecode = _bytecode;
  MgvReader__factory.abi = _abi;
  return MgvReader__factory;

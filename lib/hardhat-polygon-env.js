...
function getConfiguredTokens(polygonConfig, hre) {
  ...
  // Compund tokens
  // CDAI
  if (polygonConfig.has("tokens.cDai")) {
  ...
  // CETH
  if (polygonConfig.has("tokens.cEth")) {
...
function tryGetCompoundEnv(polygonConfig, hre) {
  ...
  let compoundConfig = polygonConfig.get("compound");
...
function tryGetMangroveEnv(polygonConfig, hre) {
  ...
  mangroveConfig = polygonConfig.get("mangrove");
  mangrove = {};

...
contract CWrappedNative is CToken, CWrappedNativeInterface {
  ...
  function liquidateBorrow(
    ...
    (uint err, ) =
      liquidateBorrowInternal(borrower, repayAmount, cTokenCollateral, false);
  ...
  function liquidateBorrowNative(
    ...
    (uint err, ) =
      liquidateBorrowInternal(borrower, msg.value, cTokenCollateral, true);
  ...
  function flashLoan(
    ...
    uint reservesFee =
      mul_ScalarTruncate(Exp({mantissa: reserveFactorMantissa}), totalFee);
